...
private fun sendChatMessage(
    ...
    val promptWithContext = chatSessionService.prepareContextAndGetPromptForChat(sessionId = currentSession.id, userMessage = ChatMessageDTO(id = UUID.randomUUID().toString(), content = prompt, isUser = true, timestamp = LocalDateTime.now()))
