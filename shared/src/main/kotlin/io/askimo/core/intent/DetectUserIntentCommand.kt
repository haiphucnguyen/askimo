...
object DetectUserIntentCommand {
    ...
    fun execute(
        ...
        val reasoning = buildString {
            if (keywordTools.isNotEmpty()) append("Keyword: ${keywordTools.size}. ")
            if (vectorOnlyTools.isNotEmpty()) append("Vector: ${vectorOnlyTools.size}. ")
            if (allMatched.isEmpty()) append("No specific tool intent detected")
        }.trimEnd()
