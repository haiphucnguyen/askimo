...
object ProxyUtil {
        ...
        when (proxyConfig.type) {
            ...
            ProxyType.HTTP, ProxyType.HTTPS -> {
                ...
                try {
                    ...
                    val proxySelector = ProxySelector.of(proxyAddress)

                    builder.proxy(proxySelector)

                    // Add authentication if credentials provided
                    if (proxyConfig.username.isNotBlank()) {
                        builder.authenticator(createAuthenticator(proxyConfig.username, proxyConfig.password))
                    }
            ...
            ProxyType.SOCKS5 -> {
                ...
                try {
                    ...
                    // SOCKS5 authentication is handled via system properties
                    // Note: This is a global setting and affects all SOCKS connections in the JVM
                    if (proxyConfig.username.isNotBlank()) {
                        ...
                        log.debug("SOCKS5 authentication configured via system properties")
                    }
    ...
    /**
     * Creates an authenticator for HTTP proxy authentication.
     *
     * @param username Proxy username
     * @param password Proxy password
     * @return Authenticator that provides credentials
     */
    private fun createAuthenticator(username: String, password: String): Authenticator = object : Authenticator() {
